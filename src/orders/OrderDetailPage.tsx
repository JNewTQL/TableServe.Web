...
function OrderDetailPage() {
  ...
  function handleShowDeleteItemModal(orderItem: IOrderItem) {
      ...
      <Modal show={!!orderItemToDelete} onHide={handleCloseDeleteItemModal}>
        ...
        <Modal.Body>
          ...
          <div className="d-flex justify-content-end gap-2">
            ...
            <button type="button" className="btn btn-danger" onClick={removeOrderItem}>
              Delete
            </button>
          </div>
        </Modal.Body>
        ...
        <div className="card p-4 mt-5">
          ...
          <table className="table w-75">
            ...
            <tbody>
              {order.orderItems.map((orderItem) => (
                <tr key={orderItem.id}>
                  ...
                  <td>
                    <Link to={`/orders/detail/${order.id}/orderitem/edit/${orderItem.id}`} className="btn btn-outline">
                      Edit
                    </Link>
                    <button type="button" className="btn btn-outline" onClick={() => handleShowDeleteItemModal(orderItem)}>
                      Delete
                    </button>
                  </td>
                </tr>
            ...
            <tfoot>
              <tr>
                <td>
                  <Link to={`/orders/detail/${order.id}/orderitem/create`} className="btn btn-outline-primary">
                    Add Order Item
                  </Link>
                </td>
                <td />
