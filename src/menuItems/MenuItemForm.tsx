  ...
  return (
    <form className="d-flex flex-wrap w-75 gap-2" onSubmit={handleSubmit(save)}>
      <div className="mb-3 w-75">
        ...
        <input id="name" type="text" {...register("name", { required: "Name is required" })} className={`form-control ${errors?.name && "is-invalid"}`} />
      ...
      <div className="mb-3 w-25">
        ...
        <input id="price" type="number" step="0.01" {...register("price", { valueAsNumber: true, required: "Price is required" })} className={`form-control ${errors?.price && "is-invalid"}`} />
      ...
      <div className="mb-3 w-50">
        ...
        <select id="categoryId" {...register("categoryId", { valueAsNumber: true, required: "Category is required" })} className={`form-select ${errors?.categoryId && "is-invalid"}`}>
